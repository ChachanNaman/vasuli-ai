...
function createBeam(width: number, height: number, isDarkMode: boolean): Beam {
  ...
  // Retinted from the default blue/cyan to Vasuli's amber accent (PRD §12.1
  // — avoid the expected blue/purple SaaS palette).
  const hueBase = isDarkMode ? 35 : 40;
  const hueRange = isDarkMode ? 30 : 25;
